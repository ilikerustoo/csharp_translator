...
or if it is c# and adds at end accordingly
*/
	if (infileext.equals("java")) {
	    outfilename = infilename + ".cs";
	} else if (infileext.equals("cs")) {
	...
	try {
      ...
      */
		...
		*/
		...
		System.out.println("Translating c# -> java");
